...
set _DeploySetParametersFile=%RootPath%KotakDocuMentor.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%KotakDocuMentor.zip" (
echo "%RootPath%KotakDocuMentor.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KotakDocuMentor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KotakDocuMentor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KotakDocuMentor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KotakDocuMentor.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KotakDocuMentor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KotakDocuMentor.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%KotakDocuMentor.deploy-readme.txt" (
...
start notepad "%RootPath%KotakDocuMentor.deploy-readme.txt"
)
echo =========================================================
goto :eof
